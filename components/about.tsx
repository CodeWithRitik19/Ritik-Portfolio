  ...
  const features = [
    {
      ...
      description: "Hands-on experience building simple and practical web apps using HTML, CSS, JavaScript, and React.",
    },
    {
      icon: Lightbulb,
      title: "Eager Learner",
      description: "Always open to learning new technologies and improving my skills through real projects and challenges.",
    },
    {
      icon: Target,
      title: "Problem Solver",
      description: "Enjoys turning ideas into real, usable solutions and learning from every step of the process.",
    },
    {
      icon: Cloud,
      title: "Team Player",
      description: "Believes in collaboration, teamwork, and contributing to group projects and campus activities.",
    },
  ]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 w-full h-full backface-hidden rounded-2xl overflow-hidden border-4 border-[#3EADCF] shadow-2xl">
                        <img src="/about-image.jpg" alt="Ritik Kumar" className="w-full h-full object-cover" />
              ...
              >
                ...
                >
                  <p>
                    Hi, I'm <span className="text-[#57D9FF] dark:text-[#0284c7] font-semibold">Ritik Kumar</span>, a passionate and curious B.Tech student at GL Bajaj Group of Institutions, based in Agra.
                  </p>
                  ...
                  <p>
                    I love problem-solving, collaborating in campus activities, and constantly learning new technologies to strengthen my foundation as a developer. I’m excited to grow my skills, take on new challenges, and connect with fellow learners and professionals.
                  </p>
                </motion.div>
